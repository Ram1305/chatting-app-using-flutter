  ...
  class SChatPage  extends StatefulWidget {
  @override
  _AtPageState createState() => _AtPageState();
  }

  class _AtPageState extends State<SChatPage > {
  @override
  ...
  context,
  MaterialPageRoute(
  builder: (context) => Chating(groupId: groupId, groupName: groupName),
  ),
  );
  },
  );
  ...
  Chating({required this.groupId, required this.groupName});

  @override
  _ChatScreenState createState() => _ChatScreenState();
  }

  class _ChatScreenState extends State<Chating> {
